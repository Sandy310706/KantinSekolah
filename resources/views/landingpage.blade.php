...
<body>
    <div class="svg-container">
        ...
        <svg class="hijau position-absolute" id="biru" xmlns="http://www.w3.org/2000/svg" width="355" height="433"
    ...
    <div class="masthead">
        <div class="container">
            <div class="row">
                ...
                <div class="col">
                    <div class="makanan">
                        <div class="nasi z-3 position-absolute" id="nasgor"><img src="landingpage/img/nasi goreng hd.png" alt="">
                        </div>
                        <div class="kuning z-1 position-absolute" id="naskun"><img src="landingpage/img/nasi kuning hd.png" alt="">
                        </div>
                        <div class="geprek z-2 position-absolute" id="geprek"><img src="landingpage/img/geprek-removebg-preview.png"
                                alt=""></div>
                    </div>
                </div>
            </div>
    ...
    <section class="menu page-section" id="portfolio">
        ...
        <div class="container Menu-Page mb-5">
            <div class="box">
                <div class="image">
                    <img src="landingpage/img/geprek-removebg-preview.png" alt="">
                </div>
                <h1>nasi</h1>
                <p>1.000.000</p>
